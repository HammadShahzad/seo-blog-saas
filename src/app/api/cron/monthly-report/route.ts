      ...
      const html = `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#111">
          ...
          <div style="padding:32px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 8px 8px">
            ...
            <a href="${appUrl}/dashboard/websites/${website.id}/analytics" style="display:inline-block;background:#4F46E5;color:white;padding:12px 24px;border-radius:6px;text-decoration:none;font-weight:600">
              View Full Analytics
            </a>
          </div>
        </div>
